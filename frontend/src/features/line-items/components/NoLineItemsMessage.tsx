  ...
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-center dark:border-amber-800/30 dark:bg-amber-900/20">
      ...
      <p className="text-sm text-amber-700 dark:text-amber-300">
        {merchant ? (
          <Trans>
            This document from {merchant} doesn't include detailed line items.
            The total amount has been equally divided among all people.
          </Trans>
        ) : (
          <Trans>
            This document doesn't include detailed line items. The total amount
            has been equally divided among all people.
          </Trans>
        )}
      </p>
    </div>
